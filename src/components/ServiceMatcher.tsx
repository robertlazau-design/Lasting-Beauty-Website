...
import { ChevronRight, ArrowLeft, Clock, DollarSign, Sparkles, RotateCcw, Copy, Check } from 'lucide-react';
                ...
                >
                  <div className="bg-gradient-to-br from-[#f5efe9] to-[#ece7e1] p-8 w-full rounded-[2rem] border border-[#e5dfd6] shadow-xl text-center relative overflow-hidden">
                    ...
                    <button
                      ...
                      className="block w-full bg-[#8c7768] text-white font-medium tracking-[0.2em] text-xs py-5 rounded-full hover:bg-[#726155] transition-all shadow-md hover:shadow-[0_4px_15px_rgba(140,119,104,0.3)] active:scale-95 duration-200 relative z-10 uppercase cursor-pointer"
                    >
                    ...
                    <button
                      ...
                      className="mt-3 inline-flex items-center gap-1.5 text-[10px] text-[#8c7768] hover:text-[#332f2c] uppercase tracking-[0.15em] font-medium transition-colors relative z-10"
                    >
                      {copied ? (
                        <>
