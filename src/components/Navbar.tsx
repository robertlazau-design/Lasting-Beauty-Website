          ...
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <div className="hidden lg:flex items-center gap-4">
              <a
                ...
                className="text-[#8c7768] hover:text-[#332f2c] transition-colors"
                title="Follow on TikTok @braids_by_lastingbeauty"
              >
              ...
              <a
                ...
                className="text-[#8c7768] hover:text-[#332f2c] transition-colors"
                title="Follow on Instagram @braids_by_lastingbeauty"
              >
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
              ...
              <div className="px-6 py-6 border-t border-[#e5dfd6] flex items-center justify-between">
                ...
                <div className="flex gap-4">
                  <a
                    ...
                    rel="noopener noreferrer"
                    aria-label="TikTok @braids_by_lastingbeauty"
                    className="text-[#8c7768] hover:text-[#332f2c] transition-colors p-1"
