          ...
          <div className="md:col-span-1">
            ...
            <div className="flex gap-4">
              <a
                href="#"
                aria-label="TikTok"
                className="w-10 h-10 rounded-full border border-[#4a413b] flex items-center justify-center hover:border-[#8c7768] hover:bg-[#8c7768]/10 transition-all duration-300"
              >
